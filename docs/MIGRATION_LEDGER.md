...
This ledger lists migration files present in the SRY-033 locked repository baseline. It records
repository migration availability, not whether a particular deployed environment has applied them.

**SRY-033 introduces no new migration.** The current repository migration range is M0001 through
M0017.
