...
export default async function CanonicalShowroomDemoPage({
  ...
  return (
    <div
      className={embedMode ? 'min-h-screen overflow-hidden bg-transparent' : 'bg-seraya-canvas min-h-screen'}
      data-showroom-mode={embedMode ? 'thumbnail' : 'full'}
    >
      {embedMode ? null : (
      ...
      <main
        className={
          embedMode
            ? 'min-h-screen overflow-hidden bg-transparent p-0'
