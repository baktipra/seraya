  ...
  return (
    <main className="bg-seraya-canvas min-h-screen overflow-x-hidden">
      ...
      <section className="relative">
        ...
        <div className="relative mx-auto grid w-full max-w-7xl gap-12 px-5 py-16 sm:px-8 sm:py-22 lg:grid-cols-[minmax(0,1.05fr)_minmax(24rem,0.95fr)] lg:items-center lg:gap-16 lg:px-10 lg:py-28">
          <div className="max-w-2xl">
            ...
            <h1 className="seraya-display-xl mt-5 max-w-2xl">
